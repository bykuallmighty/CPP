...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    g_writePlaceDelay = CreateWindowEx(
        WS_EX_CLIENTEDGE,
        "EDIT",
        "Sciezka zapisu - tymczasowego",
        WS_CHILD | WS_VISIBLE | WS_BORDER | WS_HSCROLL | ES_MULTILINE | ES_AUTOHSCROLL,
        0,
        385,
        300,
    ...
    if (options.returnIfReadOptions())
    {
        ...
        options.returnWritePlaceDelay(g_writePlaceDelay);
    ...
    SendMessage(g_writePlaceDelay, WM_SETFONT, (WPARAM)hNormalFont, 0);
    ...
    SendMessage(g_textDelay, WM_SETFONT, (WPARAM)hNormalFont, 0);
    ...
    case WM_COMMAND:
        ...
        {   
            if (ifStart)
            {
                ...
                options.setWritePlaceDelay(g_writePlaceDelay);
            ...
            break;
        case G_HBUTTONINFO:
            MessageBox(hwnd, "Witaj w Inwentaryzacji BCK\r\n"
                ...
                "\r\n\r\nKlikniecie start zapisuje opcje!", "Autor: Przemys³aw £ybyk. V 1.0", MB_OK | MB_ICONINFORMATION);
            break;
        case G_HCHECKBOX1:
        {
