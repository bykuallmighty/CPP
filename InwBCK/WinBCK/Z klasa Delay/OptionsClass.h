...
private:
    std::string readPlace_, writePlaceOne_,
        writePlaceTwo_, writePlaceDelay_, writePlaceTP01_,
        fileExt_;
...
public:
    ...
    std::string returnWritePlaceDelay()const;
    std::string returnWritePlaceDelay(HWND &)const;
    ...
    void setWritePlaceDelay(const HWND &);
